...
def reg_user(id,ref):
    ...
    if sql.fetchone() is None:
        ...
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel2', '@filmy_to', 'https://t.me/filmy_to', 100))
        sql.execute(f"INSERT INTO trafik VALUES (?,?,?,?)", ('channel3', '@novoetg', 'https://t.me/novoetg', 100))
        db.commit()
